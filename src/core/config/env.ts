...
export const envs = {
	...
	MY_MAIL_PASS:get('MY_MAIL_PASS').default('montheuyoubijoyce').asString(),
	MY_JWT_ACCES_TOKEN:get('MY_JWT_ACCESS_TOKEN').required().asString(),
	MY_JWT_REFRESH_TOKEN: get('MY_JWT_REFRESH_TOKEN').required().asString(),
};
